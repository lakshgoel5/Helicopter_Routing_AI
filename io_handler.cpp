...
ProblemData readInputData(const string& filename) {
    ...
    pkg_ss >> data.packages[0].weight >> data.packages[0].value; //d
    pkg_ss >> data.packages[1].weight >> data.packages[1].value; //p
    pkg_ss >> data.packages[2].weight >> data.packages[2].value; //o
